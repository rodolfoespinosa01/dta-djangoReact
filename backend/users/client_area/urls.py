...
from users.client_area.views.food_overrides import (
    ...
    client_product_barcode_lookup,
    client_product_image_submission_upload,
    client_product_search,
...
urlpatterns = [
    ...
    path('app/food-overrides/products/search/', client_product_search, name='client_app_product_search'),
    path('app/food-overrides/products/barcode/', client_product_barcode_lookup, name='client_app_product_barcode_lookup'),
